        ...
        <Button
          disabled={
            !usuario.permissions.find(
              (permiso) => permiso.name === "crear roles"
            )
          }
          variant="outlined"
          color="primary"
          ...
          <Table stickyHeader aria-label="sticky table">
            ...
            <TableBody>
              {rows.map((element, index) => (
                <TableRow>
                  <TableCell key={index}>{element.id}</TableCell>
                  ...
                  <TableCell align="center">
                    <Box pr={1} pl={1}>
                      <Button
                        disabled={
                          !usuario.permissions.find(
                            (permiso) => permiso.name === "editar roles"
                          )
                        }
                        variant="outlined"
                        color="primary"
            ...
            <div className={classes.paper}>
              <h1 id="transition-modal-title">
                {formType === "new" ? (
                  ...
                  <Typography variant="h4">Eliminar rol</Typography>
                )}
              </h1>
              <FormRole
                rolId={rol.id}
