        ...
        <Button
          disabled={
            !usuario.permissions.find(
              (permiso) => permiso.name === "crear unidad"
            )
          }
          variant="outlined"
          color="primary"
                  ...
                  <TableCell align="center">
                    <Box pr={1} pl={1}>
                      <Button
                        disabled={
                          !usuario.permissions.find(
                            (permiso) => permiso.name === "editar unidad"
                          )
                        }
                        variant="outlined"
                        color="primary"
                      ...
                      <Button
                        disabled={
                          !usuario.permissions.find(
                            (permiso) => permiso.name === "eliminar unidad"
                          )
                        }
                        variant="outlined"
                        color="secondary"
          ...
          <Fade in={open}>
            <div className={classes.paper}>
              <h1 id="transition-modal-title">
                {formType === "new" ? (
                  <Typography variant="h4">Crear unidad</Typography>
                ) : formType === "edit" ? (
                  <Typography variant="h4">Editar unidad</Typography>
                ) : (
                  <Typography variant="h4">Eliminar unidad</Typography>
                )}
              </h1>
              <FormUbicacion
                unidadId={unidad.id}
